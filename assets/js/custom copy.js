    ...
    $(document).on("change", ".pid", function(a) {
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                d.find(".tprice").val(d.find(".oqty").val() * d.find(".price").val());
                t(0);
            }
        });
    });
        ...
        if (t !== null && e !== null) {
            $.ajax({
                ...
                success: function(a) {
                    var t = a;
                    if (!isNaN(t)) {
                        window.location.href = "index.php?page=view_sell&&view_id=" + t;
                    } else {
...
$(document).on("click", "#editSellBtn", function(a) {
    a.preventDefault();
    var t = confirm("Are you sure you want to edit this sell"),
        e = $("#payMethode").val();
    if (t) {
        if (e !== null) {
            $.ajax({
...
$(document).on("keyup", ".returnQty", function(a) {
    ...
    if (t.val() - 0 > e.find(".orderQty").val() - 0) {
        alert("Return quantity must not be greater than order quantity");
    }
});
...
$("#returnSellBtn").on("click", function(a) {
    ...
    $(".orderQty").val();
    $(".returnQty").val();
    if (confirm("Are you sure you want to edit this sell")) {
        $.ajax({
